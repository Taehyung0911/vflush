...
extern int blkdev_issue_flush(unsigned long, struct block_device *, gfp_t, sector_t *);
...
static inline int blkdev_issue_flush(unsigned long inum, struct block_device *bdev, gfp_t gfp_mask,
