...
//#if TAG_BUFFER
	...
	SETREG(SATA_FIS_H2D_4, 0x00000000);

	if(num_entry){
		UINT8 i;
		for(i=0; i<num_entry; i++){
			if(inum_table[i] == fis_d4){
				fis_d4 = i;
				break;
			}
		}
	...
	SETREG(SATA_FIS_H2D_2, 0x00000000);
//#endif
...
#if TAG_BUFFER
		g_sata_context.slow_cmd.lba = (fis_d4 & 0x7);
#else
